...
class clock:
    ...
    def __str__(self):
        hourSec = self.__hour*60*60
        minSec = self.__minute*60
        sec = self.__minute
        time =hourSec+minSec+sec 
        return time
...
print('Clock: ',clock_seconds.__str__(), 'in Seconds.')
#program output
##Return my time in total seconds
##Enter a hour: 24
##Enter a minute: 01
##Enter seconds: 1
##(86461, 'seconds')
