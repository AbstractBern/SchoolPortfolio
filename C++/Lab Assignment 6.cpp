...
void Display(const double Monkey_DailyIntake[][NUM_DAYS], const string Week[], const string Monkey[], const int MONK, const int NUM_DAYS)		
{																					//Display function 	passes all arrays and const int
...
float AverageIntake_OfAll(const double Monkey_DailyIntake[][NUM_DAYS], const int MONK, const int NUM_DAYS)	//AverageIntake_OfALl 
{																							//passes MonkeyIntake array and const ints
...
float WhoAteTheLeast(const double Monkey_DailyIntake[][NUM_DAYS], const int MONK, const int NUM_DAYS)
{																							//WHoAteTHeLeast is passed the MonkeyIntake array and const ints
